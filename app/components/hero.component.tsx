...
const Hero = () => {
                    return (
                      ...
                      className="ralative w-full h-[98vh] ">
       ...
       className="font-outfit text-6xl text-white whitespace-pre-line text-center">Begin your dream journey with our expert guidance and support</motion.h1>
                                      ...
                                      <div className=" w-full  flex flex-row  items-end p-14    ">
                                        <div className="flex flex-col gap-5 w-1/2 ">
                                          <motion.button variants={fadeIn("right", "tween", 0.40, 0.40)} className="bg-transparent text-white font-outfitsubtext border w-fit px-5 py-4 rounded-full font-light flex flex-row items-center gap-2">
                                        ...
                                        <motion.button variants={fadeIn("left", "tween", 0.5, 0.5)} className="bg-transparent text-white font-outfitsubtext border w-fit px-5 py-4 rounded-full font-light flex flex-row items-center gap-2">
                                            Explore more
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-8">
