      ...
      <div className="flex flex-col sm:flex-row mt-5 gap-10">
        <div className="sm:w-1/2 w-full">
          <motion.p
            ...
            className="text-black font-outfitsubtext font-light text-4xl leading-tight  "
          >
        ...
        <motion.div
          variants={fadeIn("left", "tween", 0.5, 0.5)}
          className="flex flex-col justify-end items-center sm:w-1/2 w-full "
        >
          <div className="flex flex-row ">
            <div className="flex flex-col justify-center items-center gap-1 text-center">
              <h3 className="text-black font-outfitsubtext font-normal text-4xl leading-tight ">
                78+
              </h3>
